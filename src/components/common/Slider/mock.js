export const slides = [
  ...
  },
  {
    ...
    description: ['Начинаем с инициализации package.json. Далее можем устанавливать необходимые пакеты.'],
    list: [
  ...
  {
    description: ['Файлы'],
    list: ['file-loader — настройка Webpack для работы с картинками/шрифтами.'],
  },
  {
    description: ['PostCSS'],
    list: [
